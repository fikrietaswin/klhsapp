...
void main() => runApp(new MaterialApp(
  ...
  theme: new ThemeData(
    ...
    primaryColor: Colors.pinkAccent, backgroundColor: Colors.white
  ),
  home: new Tabs(),
...
const List<TabItem> TabItems = const <TabItem>[
  ...
  const TabItem(title: 'Coming soon', icon: Icons.dashboard),
  const TabItem(title: 'Chat', icon: Icons.message)
];